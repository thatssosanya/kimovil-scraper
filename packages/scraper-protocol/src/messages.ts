...
export class StreamEvent extends Schema.Class<StreamEvent>("StreamEvent")({
  ...
  event: Schema.Union(
    ...
    Schema.Struct({
      ...
      job: Schema.Struct({
        id: Schema.String,
        jobType: Schema.optional(Schema.Literal("scrape", "process_raw", "process_ai", "clear_html", "clear_raw", "clear_processed", "link_priceru", "discover_latest")),
...
// Job type schemas
export const JobTypeSchema = Schema.Literal("scrape", "process_raw", "process_ai", "clear_html", "clear_raw", "clear_processed", "link_priceru", "discover_latest");
